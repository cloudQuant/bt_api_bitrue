...
This package provides **Bitrue exchange plugin for bt_api framework** for the [bt_api](https://github.com/cloudQuant/bt_api_py) framework. It offers a unified interface for interacting with **BITRUE** exchange.
...
| GitHub Repository | https://github.com/cloudQuant/bt_api_bitrue |
| Issue Tracker | https://github.com/cloudQuant/bt_api_bitrue/issues |
...
- Report bugs via [GitHub Issues](https://github.com/cloudQuant/bt_api_bitrue/issues)
...
本包为 [bt_api](https://github.com/cloudQuant/bt_api_py) 框架提供 **Bitrue exchange plugin for bt_api framework**。它提供了与 **BITRUE** 交易所交互的统一接口。
...
| GitHub 仓库 | https://github.com/cloudQuant/bt_api_bitrue |
...
- 通过 [GitHub Issues](https://github.com/cloudQuant/bt_api_bitrue/issues) 反馈问题
